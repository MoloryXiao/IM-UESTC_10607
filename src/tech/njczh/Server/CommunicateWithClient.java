...
public class CommunicateWithClient {
    ...
    public void sendFriendList(ArrayList<Account> list) throws IOException {
        ...
        for (int i = 0; i < number; i++) {
            ...
            sendDataToClient(ac.getID() + " " + ac.getNikeName() + " " + ac.getOnlineStatus() + " " + ac.getSignature());
        }
    }
